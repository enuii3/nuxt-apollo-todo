...
id?: string},{$scopedSlots: Readonly<{
...
width?: number|string},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined
...
'img':(args: {props:{ height: string, src: string | srcObject }}) => VNode[]}>}
>
VAppBarNavIcon: DefineComponent<{},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined}>}
>
VAppBarTitle: DefineComponent<{},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined}>}
>
...
valueComparator?: Function},{$scopedSlots: Readonly<{
...
'counter':(args: {props:{"dark":boolean,"light":boolean,"max":string | number,"value":string}}) => VNode[]
/** Define a custom item appearance */
'item':(args: {parent:VueComponent
item:{ [key: keyof any]: any }
on:{ [key: keyof any]: any } 
attrs:{ [key: keyof any]: any } }) => VNode[]
/** Replaces the default label */
'label':undefined
'message':(args: {key:number, 
...
'selection':(args: {parent:VueComponent
item:{ [key: keyof any]: any }
index:number
select:function
selected:boolean
disabled:boolean}) => VNode[]}>}
>
...
transition?: string
/** Controls whether the component is visible or hidden. */
value?: any},{$scopedSlots: Readonly<{
...
value?: any
/** Sets the width for the component. */
width?: string|number},{$scopedSlots: Readonly<{
...
'activator':(args: {on:{ [eventName: string]: eventHandler }
value:boolean}) => VNode[]
/** The default Vue slot. */
'default':undefined}>}
>
...
large?: boolean
/** Applies the light theme variant to the component. */
light?: boolean},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined
...
to?: string|object},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined}>}
>
...
xSmall?: boolean},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined
/** Custom loader. */
'loader':undefined}>}
...
weekdays?: any[]|string},{$scopedSlots: Readonly<{
...
present:boolean
future:boolean
week:[{"date":string,"time":string,"year":number,"month":number,"day":number,"hour":number,"minute":number,"weekday":number,"hasDay":boolean,"hasTime":boolean,"past":boolean,"present":boolean,"future":boolean}]
category:string | null}) => VNode[]
/** The content that is placed in a `week` or `month` view. The day & time object is passed through this slots scope. */
'day':(args: {outside:boolean
index:number
week:[{"date":string,"time":string,"year":number,"month":number,"day":number,"hour":number,"minute":number,"weekday":number,"hasDay":boolean,"hasTime":boolean,"past":boolean,"present":boolean,"future":boolean}]
date:string
time:string
...
week:[{"date":string,"time":string,"year":number,"month":number,"day":number,"hour":number,"minute":number,"weekday":number,"hasDay":boolean,"hasTime":boolean,"past":boolean,"present":boolean,"future":boolean}]}) => VNode[]
/** The content that is placed in a `day` view in the top container. The day & time object is passed through this slots scope. */
'day-header':(args: {date:string
time:string
year:number
month:number
day:number
...
'day-label-header':(args: {date:string
time:string
year:number
month:number
day:number
...
tag?: string},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined}>}
>
...
verticalDelimiters?: string},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined
/** Slot displaying the arrow switching to the next item */
'next':(args: {attrs:{ "aria-label": string }
on:{ click: eventHandler }}) => VNode[]
/** Slot displaying the arrow switching to the previous item */
'prev':(args: {attrs:{ "aria-label": string }
on:{ click: eventHandler }}) => VNode[]}>}
>
...
'default':(args: {items:any[]
originalItemsLength:number
pagination:{"page":number,"itemsPerPage":number,"pageStart":number,"pageStop":number,"pageCount":number,"itemsLength":number}
options:{"page":number,"itemsPerPage":number,"sortBy":string[],"sortDesc":boolean[],"groupBy":string[],"groupDesc":boolean[],"multiSort":boolean,"mustSort":boolean}
...
expand:(item: any, value: boolean) => void}) => VNode[]
/** Defines a footer below the items */
'footer':(args: {items:any[]
originalItemsLength:number
pagination:{"page":number,"itemsPerPage":number,"pageStart":number,"pageStop":number,"pageCount":number,"itemsLength":number}
options:{"page":number,"itemsPerPage":number,"sortBy":string[],"sortDesc":boolean[],"groupBy":string[],"groupDesc":boolean[],"multiSort":boolean,"mustSort":boolean}
groupedItems:Array<{ name: string, items: any[] }>
...
sort:(value: string) => void
sortArray:(sortBy: string[]) => void
group:(value: string) => void}) => VNode[]
/** This slot is forwarded to the default footer. See the [`v-data-footer`](/api/v-data-footer) API for more information */
'footer.page-text':(args: {pageStart:number
pageStop:number
itemsLength:number}) => VNode[]
'header':(args: {items:any[]
originalItemsLength:number
pagination:{"page":number,"itemsPerPage":number,"pageStart":number,"pageStop":number,"pageCount":number,"itemsLength":number}
options:{"page":number,"itemsPerPage":number,"sortBy":string[],"sortDesc":boolean[],"groupBy":string[],"groupDesc":boolean[],"multiSort":boolean,"mustSort":boolean}
groupedItems:Array<{ name: string, items: any[] }>
...
group:(value: string) => void}) => VNode[]
/** Slot for each item */
'item':(args: {expand:(v: boolean) => void
index:number
item:any
isExpanded:boolean
isMobile:boolean
isSelected:boolean
select:(v: boolean) => void}) => VNode[]
...
showFirstLastPage?: boolean},{$scopedSlots: Readonly<{
/** Defines content for the items-per-page text */
'page-text':(args: {pageStart:number
pageStop:number
itemsLength:number}) => VNode[]
...
'expanded-item':(args: {isMobile:boolean
item:any
headers:DataTableHeader[]}) => VNode[]
...
'footer':(args: {props:{"options":{"page":number,"itemsPerPage":number,"sortBy":string[],"sortDesc":boolean[],"groupBy":string[],"groupDesc":boolean[],"multiSort":boolean,"mustSort":boolean},"pagination":{"page":number,"itemsPerPage":number,"pageStart":number,"pageStop":number,"pageCount":number,"itemsLength":number},"itemsPerPageText":string}
on:{}
headers:DataTableHeader[]
widths:[]}) => VNode[]
...
'group.header':(args: {group:string
groupBy:string[]
isMobile:boolean
items:any[]
headers:DataTableHeader[]
...
'group.summary':(args: {group:string
groupBy:string[]
isMobile:boolean
items:any[]
headers:DataTableHeader[]
isOpen:boolean
toggle:() => void}) => VNode[]
'header':(args: {isMobile:boolean
props:{"headers":DataTableHeader[],"options":{"page":number,"itemsPerPage":number,"sortBy":string[],"sortDesc":boolean[],"groupBy":string[],"groupDesc":boolean[],"multiSort":boolean,"mustSort":boolean},"mobile":boolean,"showGroupBy":boolean,"someItems":boolean,"everyItem":boolean}
on:{"sort":(value: string) => void,"group":(value: string) => void,"toggle-select-all":(value: boolean) => void}}) => VNode[]
/** Slot to customize a specific header column */
[name:`header.${string}`]:(args: {header:DataTableHeader}) => VNode[]
/** Slot to replace the default `v-simple-checkbox` in header */
'header.data-table-select':(args: {isMobile:boolean
props:{"value":boolean,"indeterminate":boolean}
on:{"input":(value: boolean) => void}}) => VNode[]
...
[name:`item.${string}`]:(args: {isMobile:boolean
item:any
header:DataTableHeader
value:any
index:number}) => VNode[]
/** Slot to replace the default `v-icon` used when expanding rows */
'item.data-table-expand':(args: {expand:(v: boolean) => void
index:number
item:any
isExpanded:boolean
isMobile:boolean
...
'item.data-table-select':(args: {expand:(v: boolean) => void
index:number
item:any
isExpanded:boolean
isMobile:boolean
...
saveText?: any
/** Sets the component transition. Can be one of the [built in transitions](/styles/transitions) or one your own. */
transition?: string},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined
...
yearIcon?: string},{$scopedSlots: Readonly<{
...
hideActions?: boolean
/** Applies the [v-ripple](/directives/ripple) directive. */
ripple?: boolean|object},{$scopedSlots: Readonly<{
...
color?: string
/** Will force the components content to render on mounted. This is useful if you have content that will not be rendered in the DOM that you want crawled for SEO. */
eager?: boolean},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined}>}
>
...
value?: boolean},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined}>}
>
...
xl?: boolean|string|number},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined}>}
>
...
value?: any},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':(args: {active:boolean
toggle:(...args: any[]) => any}) => VNode[]}>}
>
...
toggle:(...args: any[]) => any}) => VNode[]}>}
>
VListItemAction: DefineComponent<{},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined}>}
>
...
'default':undefined}>}
>
VListItemIcon: DefineComponent<{},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined}>}
>
...
zIndex?: number|string},{$scopedSlots: Readonly<{
/** When used, will activate the component when clicked (or hover for specific components). This manually stops the event propagation. Without this slot, if you open the component through its model, you will need to manually stop the event propagation */
'activator':(args: {attrs:{ role: string, "aria-haspopup": boolean, "aria-expanded": string }
...
'img':(args: {height:string
src:string | srcObject}) => VNode[]
...
src?: string
/** A set of alternate images to use based on device size. [Read more...](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#attr-srcset) */
srcset?: string},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined}>}
>
...
top?: boolean
/** The designated model value for the component. */
value?: number|string},{$scopedSlots: Readonly<{
...
vertical?: boolean},{$scopedSlots: Readonly<{
/** Adds an item inside the input and after input content */
'append':undefined
/** The default Vue slot. */
'default':undefined
...
step?: number|string},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined}>}
>
...
reverse?: boolean},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined}>}
>
...
right?: boolean
/** Small size dot */
small?: boolean},{$scopedSlots: Readonly<{
/** The default Vue slot. */
'default':undefined
